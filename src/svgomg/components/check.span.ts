...
export class CheckSpanInput extends CheckInput {

    private readonly spanSelector = 'span'
    ...
    private async getSpanElement(checkValues?: string[]) {
        ...
        if (checkValues) {
            ...
            return await page.waitForSelector(
                `${this.selector} + ${this.spanSelector}`, { state: 'attached', timeout: this.timeoutElement }
            )
        }
    }
